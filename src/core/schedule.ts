 ...
 * runs. Framework-free and dependency-free so the Host scheduler and the
 * browser view share one tiny pure module.
 *
 ...
 * at minute granularity, strictly greater than `fromMs`. Returns undefined
 * when nothing matches within 366 days (e.g. `0 0 30 2 *`).
 */
